...
export const DEFAULT_ROLES: Role[] = [
  ...
  { id: 'physician',   name: 'Physician',   description: 'External ordering physician. Directory only â€” no app access.',                   color: '#C084FC', caseAccess: false, configAccess: false, permissions: DEFAULT_ROLE_PERMISSIONS['Physician'],canViewPediatric: false,   builtIn: true, participationTypeIds: []                                        },
];

// Mock client list â€” replace with clientService.getAll() when wired
const MOCK_CLIENTS = [
...
// â”€â”€â”€ TriCheckbox â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const TriCheckbox: React.FC<{ state: TriState; onClick: (e: React.MouseEvent) => void; size?: number }> = ({ state, onClick, size = 16 }) => (
  ...
  >
    {state === 'all'  && <span style={{ color: '#0d1117', fontSize: size * 0.6, fontWeight: 900 }}>âœ“</span>}
    {state === 'some' && <span style={{ color: '#8AB4F8', fontSize: size * 0.75, fontWeight: 900, lineHeight: 1 }}>â€”</span>}
  </div>
);

// â”€â”€â”€ RoleModal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const RoleModal: React.FC<{
  ...
  // Cheat sheet â€” all actions across all groups filtered by search
    ...
    <div data-capture-hide="true" style={{ ...overlay, alignItems: 'flex-start', overflowY: 'auto', padding: '32px 0' }} onClick={onClose}>
      ...
      >
        ...
        <div style={{ ...modalHeaderStyle, padding: '16px 24px', borderBottom: '1px solid rgba(255,255,255,0.08)', flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', color: '#6b7280', fontSize: 22, cursor: 'pointer', padding: 4, lineHeight: 1 }}>Ã—</button>
        </div>
                    ...
                    return (
                      ...
                      >
                        <div style={{
                          ...
                          {granted && <span style={{ color: '#0d1117', fontSize: 10, fontWeight: 900 }}>âœ“</span>}
                        </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px' }}>
              ...
              >
                <div style={{
                  ...
                  {allClients && <span style={{ color: '#0d1117', fontSize: 11, fontWeight: 900 }}>âœ“</span>}
                </div>
                <div>
                    ...
                    return (
                      ...
                      >
                        <div style={{
                          ...
                          {selected && <span style={{ color: '#0d1117', fontSize: 9, fontWeight: 900 }}>âœ“</span>}
                        </div>
                        <div>
              ...
              {!allClients && (draft.clientIds ?? []).length === 0 && (
                <div style={{ marginTop: 12, padding: '10px 14px', borderRadius: 8, background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', fontSize: 13, color: '#f87171' }}>
                  âš  No clients selected â€” this role will have no data access. Select at least one client or switch to All Clients.
                </div>
              )}
            </div>
          )}

          {/* â”€â”€ CASE PARTICIPATION TAB â”€â”€ */}
            ...
            return (
              <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px' }}>
                <p style={{ fontSize: 13, color: '#6b7280', marginBottom: 8, lineHeight: 1.6 }}>
                  ...
                  Participation types are defined in <strong style={{ color: '#e5e7eb' }}>System â†’ Participation Types</strong>.
                </p>
                {!draft.caseAccess && (
                  <div style={{ marginBottom: 16, padding: '8px 12px', borderRadius: 8, background: 'rgba(251,191,36,0.08)', border: '1px solid rgba(251,191,36,0.2)', color: '#fbbf24', fontSize: 12 }}>
                    âš  This role has no Case Access â€” participation types will have no effect until Case Access is enabled.
                  </div>
                )}
                {allTypes.length === 0 ? (
                  <div style={{ padding: '40px 20px', textAlign: 'center', color: '#4b5563', fontSize: 13, border: '1px dashed rgba(255,255,255,0.08)', borderRadius: 12 }}>
                    ...
                    <span style={{ color: '#6b7280' }}>Go to System â†’ Participation Types to add some.</span>
                  </div>
                ) : (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{ width: 18, height: 18, borderRadius: 4, flexShrink: 0, marginTop: 2, border: `2px solid ${selected ? '#8AB4F8' : '#374151'}`, background: selected ? '#8AB4F8' : 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.15s' }}>
                            {selected && <span style={{ color: '#0d1117', fontSize: 10, fontWeight: 900 }}>âœ“</span>}
                          </div>
                          {/* Chip */}
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
              <div style={{ padding: '12px 16px', borderBottom: '1px solid rgba(255,255,255,0.06)', flexShrink: 0 }}>
                <input
                  ...
                  placeholder="Search actions by name, description, category, or IDâ€¦"
                  ...
                  return (
                    <div key={action.id} style={{
                      ...
                      <div style={{ fontSize: 10, color: '#374151', marginTop: 4, fontFamily: 'monospace' }}>
                        {action.id} Â· {action.internalKey}
                      </div>
                    </div>
                  );
                })}
        ...
        <div style={{ ...modalFooterStyle, padding: '12px 24px', borderTop: '1px solid rgba(255,255,255,0.08)', flexShrink: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: 12, color: '#4b5563' }}>
            {permCount} permissions Â· {allClients ? 'All clients' : `${(draft.clientIds ?? []).length} client(s)`}
          </span>
...
// â”€â”€â”€ Main RoleDictionary â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const RoleDictionary: React.FC<{ onRolesChange?: (roles: Role[]) => void }> = ({ onRolesChange }) => {
  ...
  if (loading) return (
    <div style={{ padding: '40px 24px', textAlign: 'center', color: '#6b7280', fontSize: 14 }}>Loading rolesâ€¦</div>
  );
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <input type="text" placeholder="Search rolesâ€¦" value={search} onChange={e => setSearch(e.target.value)}
            ...
            {filtered.map((role, i) => {
              ...
              return (
                <tr key={role.id}
                  ...
                  <td style={{ padding: '14px 16px' }}>
                    <span style={{ fontSize: 12, fontWeight: 600, color: role.caseAccess ? '#22c55e' : '#374151' }}>{role.caseAccess ? 'âœ“ Yes' : 'â€” No'}</span>
                  ...
                  <td style={{ padding: '14px 16px' }}>
                    <span style={{ fontSize: 12, fontWeight: 600, color: role.configAccess ? '#22c55e' : '#374151' }}>{role.configAccess ? 'âœ“ Yes' : 'â€” No'}</span>
                  </td>
                  <td style={{ padding: '14px 16px' }}>
                    <span style={{ fontSize: 12, color: allClients ? '#22c55e' : '#8AB4F8', fontWeight: 600 }}>
                      {allClients ? 'ðŸŒ All' : `${role.clientIds?.length} client${(role.clientIds?.length ?? 0) !== 1 ? 's' : ''}`}
                    </span>
                  </td>
                  <td style={{ padding: '14px 16px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
