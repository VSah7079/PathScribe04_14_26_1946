...
export interface StaffUser {
  ...
  email: string;
  roles: string[];
  npi: string;           // US National Provider Identifier â€” used for HL7 matching
  gmcNumber?: string;    // UK General Medical Council number â€” used for HL7 matching
  license: string;
  phone: string;
  department: string;
  signatureUrl?: string;
...
// â”€â”€â”€ Signature Upload â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      {url ? (
        ...
        <div onClick={() => ref.current?.click()} style={{ border: '2px dashed #374151', borderRadius: 8, padding: '16px', textAlign: 'center', cursor: 'pointer', color: '#6b7280', fontSize: 13 }}
          ...
          <div style={{ fontSize: 11, marginTop: 4, color: '#4b5563' }}>PNG, JPG, SVG â€” transparent background recommended</div>
        </div>
      )}
    ...
    <div data-capture-hide="true" className="ps-conf-backdrop" onClick={onClose}>
      <div className="ps-conf-modal" onClick={e => e.stopPropagation()}>
        <div className="ps-conf-modal-header" style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
          <span>{mode === 'add' ? 'Add Staff Member' : `Edit â€” ${[user?.firstName, (user as any)?.middleName, user?.lastName].filter(Boolean).join(' ')}`}</span>
          <button
            onClick={onClose}
        ...
        <div className="ps-conf-modal-body">
                  ...
                  {draft.roles.map(rName => {
                    ...
                    return (
                      <span key={rName} style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '3px 10px', borderRadius: 999, fontSize: 12, fontWeight: 600, background: `${color}22`, color, border: `1px solid ${color}44` }}>
                        {rName}
                        <span onClick={() => set('roles', draft.roles.filter(x => x !== rName))} style={{ cursor: 'pointer', fontSize: 12, lineHeight: 1, color, opacity: 0.7 }}>Ã—</span>
                      </span>
                    );
                  })}
                </div>
          ...
          {/* Row 3: Phone | Department â€” moved up */}
          <div className="ps-conf-form-row">
            <div className="ps-conf-form-field">
          ...
          {/* Row 6: License | Voice Profile â€” stray â–¼ div removed */}
          <div className="ps-conf-form-row">
            <div className="ps-conf-form-field">
...
// â”€â”€â”€ Main StaffTab â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Staff Shell (sub-tabs) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
