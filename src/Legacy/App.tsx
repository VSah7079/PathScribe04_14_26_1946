...
// Synoptic Template Editor — build/edit synoptic templates from scratch or imported base
              ...
              <SpecimenDictionaryProvider>
                <Routes>
                  ...
                  <Route element={<ProtectedRoute />}>
                    ...
                    {/* Synoptic review — opens TemplateRenderer for lifecycle transitions */}
                    <Route path="/template-review/:templateId" element={<TemplateRenderer />} />

                    {/* Synoptic editor — build or edit a template's fields, sections & coding */}
                    {/* :templateId = existing protocol id  |  "new" = blank template */}
