...
const SEED: ParticipationTypeRecord[] = [
  { id: 'primary',          label: 'Primary Pathologist',    description: 'Responsible pathologist — signs out the case',                       color: '#8AB4F8', icon: '🔬', allowsMultiple: false, requiresNote: false, active: true,  isSystem: true, sortOrder: 1 },
  { id: 'resident',         label: 'Resident / Fellow',      description: 'Trainee assigned for supervised reporting',                           color: '#60a5fa', icon: '🎓', allowsMultiple: true,  requiresNote: false, active: true,  isSystem: true, sortOrder: 2 },
  { id: 'attending',        label: 'Attending / Supervisor',  description: 'Supervising pathologist for trainee cases',                           color: '#818cf8', icon: '👨‍⚕️', allowsMultiple: false, requiresNote: false, active: true,  isSystem: true, sortOrder: 3 },
  { id: 'consultant',       label: 'Consultant',              description: 'Second opinion or specialist review — does not sign out',             color: '#38bdf8', icon: '💬', allowsMultiple: true,  requiresNote: true,  active: true,  isSystem: true, sortOrder: 4 },
  { id: 'grossing',         label: 'Grossing Pathologist',    description: 'Performed gross examination and dictation',                           color: '#81C995', icon: '✂️', allowsMultiple: false, requiresNote: false, active: true,  isSystem: true, sortOrder: 5 },
  { id: 'frozen',           label: 'Frozen Section',          description: 'Issued intraoperative frozen section report',                         color: '#4ade80', icon: '🧊', allowsMultiple: false, requiresNote: false, active: true,  isSystem: true, sortOrder: 6 },
  { id: 'transcriptionist', label: 'Transcriptionist',        description: 'Transcribed dictated report',                                         color: '#6b7280', icon: '⌨️', allowsMultiple: false, requiresNote: false, active: true,  isSystem: true, sortOrder: 7 },
  { id: 'clinician',        label: 'Requesting Clinician',    description: 'Clinician who submitted the specimen — for notification tracking',    color: '#f59e0b', icon: '🏥', allowsMultiple: true,  requiresNote: false, active: true,  isSystem: true, sortOrder: 8 },
  { id: 'external',         label: 'External Reviewer',       description: 'Outside institution or specialist — formal referral',                 color: '#8b5cf6', icon: '🌐', allowsMultiple: false, requiresNote: true,  active: true,  isSystem: true, sortOrder: 9 },
];
