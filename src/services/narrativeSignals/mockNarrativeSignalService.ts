...
function load(): NarrativeEditSignal[] {
  ...
  const SEED: SeedSignal[] = [
    ...
    { caseId: 'case-002', accessionNumber: 'S26-4402-BX-001', reportTemplateId: templateId, templateName, sectionId: 'gross_description',   sectionTitle: 'Specimen & Gross Description',    aiGeneratedClean: 'Mastectomy specimen [MEASUREMENT] in length. Tumour [MEASUREMENT] diameter.', finalTextClean: 'Mastectomy specimen [MEASUREMENT] in length with overlying skin ellipse [DIMENSIONS]. Tumour [MEASUREMENT] diameter centrally located.', structuralEditType: 'added_content',  editRatio: 0.24, wasAccepted: false, subspecialtyId: 'breast', studyId, capturedAt: daysAgo(18) },
    { caseId: 'case-003', accessionNumber: 'S26-4403-BX-001', reportTemplateId: templateId, templateName, sectionId: 'gross_description',   sectionTitle: 'Specimen & Gross Description',    aiGeneratedClean: 'Core biopsy specimen [VALUE] cores. Adequate for histological evaluation.', finalTextClean: 'Core biopsy specimen [VALUE] cores submitted in entirety. Adequate for histological evaluation.', structuralEditType: 'minor_wording',  editRatio: 0.09, wasAccepted: false, subspecialtyId: 'breast', studyId, capturedAt: daysAgo(15) },
    { caseId: 'case-004', accessionNumber: 'S26-4404-BX-001', reportTemplateId: templateId, templateName, sectionId: 'gross_description',   sectionTitle: 'Specimen & Gross Description',    aiGeneratedClean: 'Wide local excision [MEASUREMENT]. Margins inked per protocol.', finalTextClean: 'Wide local excision [MEASUREMENT]. Margins inked per protocol.', structuralEditType: 'none',           editRatio: 0,    wasAccepted: true,  subspecialtyId: 'breast', studyId, capturedAt: daysAgo(12) },
    ...
    { caseId: 'case-002', accessionNumber: 'S26-4402-BX-001', reportTemplateId: templateId, templateName, sectionId: 'biomarkers',         sectionTitle: 'Biomarker Results',               aiGeneratedClean: 'Immunohistochemistry performed. [BIOMARKER_RESULT] [BIOMARKER_RESULT] [BIOMARKER_RESULT] by [VALUE] methodology.', finalTextClean: 'Immunohistochemistry performed on [BLOCK_ID]. [BIOMARKER_RESULT] [BIOMARKER_RESULT] [BIOMARKER_RESULT] by [VALUE] methodology.', structuralEditType: 'minor_wording',  editRatio: 0.07, wasAccepted: false, subspecialtyId: 'breast', studyId, capturedAt: daysAgo(18) },
    // ancillary_and_diagnosis — more editing
    { caseId: 'case-001', accessionNumber: 'S26-4401-BX-001', reportTemplateId: templateId, templateName, sectionId: 'ancillary_and_diagnosis', sectionTitle: 'Ancillary Testing & Final Diagnosis', aiGeneratedClean: 'Final diagnosis: invasive carcinoma [VALUE] type [VALUE] grade. [BIOMARKER_RESULT] [BIOMARKER_RESULT]. [pTNM_STAGE].', finalTextClean: 'Final diagnosis: invasive carcinoma [VALUE] type [VALUE] grade. [BIOMARKER_RESULT] [BIOMARKER_RESULT]. [pTNM_STAGE]. Reported in conjunction with [VALUE] multidisciplinary team.', structuralEditType: 'added_content',  editRatio: 0.22, wasAccepted: false, subspecialtyId: 'breast', studyId, capturedAt: daysAgo(20) },
